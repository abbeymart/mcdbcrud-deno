...
export function validateSaveParams(crudParams: CrudParamsType) {
  ...
  try {
    if (crudParams.table) {
      ...
      if (!testItem) {
        errors.table = mcMessages.isStringAlpha ||
          "format-error, should be a string/alphanumeric";
      }
    } else {
      errors.table = mcMessages.infoRequired ||
    ...
    if (crudParams.recordIds) {
      ...
      if (!testItem) {
        errors.recordIds = mcMessages.isArray ||
          "format-error, should be an array[]";
      }
    }
    ...
    if (crudParams.actionParams) {
      ...
      if (!testObject) {
        errors.actionParams = mcMessages.isArray ||
          "format-error, should be an array";
      }
    } else {
      errors.queryParams = mcMessages.infoRequired ||
        "required-error, info required";
    }
    ...
    if (crudParams.queryParams) {
      ...
      if (!testObject) {
        errors.queryParams = mcMessages.isObject ||
          "format-error, should be an object{}";
      }
    }
    ...
    if (crudParams.existParams) {
      ...
      if (!testItem) {
        errors.existParams = mcMessages.isArray ||
          "format-error, should be an array[]";
      }
    } else {
      errors.existParams = mcMessages.infoRequired ||
        "required-error, info is required";
    }
    ...
    if (crudParams.token) {
      ...
      if (!testItem) {
        errors.token = mcMessages.isStringAlpha ||
          "format-error, should be a string/alphanumeric";
      }
    }
    ...
    if (crudParams.userInfo) {
      ...
      if (!testItem) {
        errors.userInfo = mcMessages.isObject ||
          "format-error, should be an object{}";
      }
    }
...
export function validateDeleteParams(crudParams: CrudParamsType) {
  ...
  try {
    ...
    if (
      (!crudParams.recordIds || crudParams.recordIds.length < 1) &&
      (!crudParams.queryParams || utils.isEmptyObject(crudParams.queryParams))
    ) {
      errors.recordIds = errors.recordIds
        ? errors.recordIds + " | docId or queryParams is required"
        : "docId or queryParams is required";
      errors.queryParams = errors.queryParams
        ? errors.queryParams + " | docId or queryParams is required"
        : "docId or queryParams is required";
    }
    ...
    if (crudParams.token) {
      ...
      if (!testItem) {
        errors.token = mcMessages.isStringAlpha ||
          "format-error, should a string/alphanumeric";
      }
    }
...
export function validateGetParams(crudParams: CrudParamsType) {
  ...
  try {
    if (crudParams.table) {
      ...
      if (!testItem) {
        errors.table = mcMessages.isStringAlpha ||
          "format-error, collection name should be a string";
      }
    } else {
      errors.table = mcMessages.infoRequired ||
        "required-error, info is required";
    ...
    if (crudParams.queryParams) {
      ...
      if (!testItem) {
        errors.queryParams = mcMessages.isObject ||
          "format-error, queryParams should be an object";
      }
    }
    ...
    if (crudParams.projectParams) {
      ...
      if (!testItem) {
        errors.projectParams = mcMessages.isObject ||
          "format-error, projectParams should be an object";
      }
    }
    ...
    if (crudParams.sortParams) {
      ...
      if (!testItem) {
        errors.sortParams = mcMessages.isObject ||
          "format-error, sortParams should be an object";
      }
    }
    ...
    if (crudParams.recordIds) {
      ...
      const testItem = utils.isArrayType(crudParams.recordIds);
      if (!testItem) {
        errors.docId = mcMessages.isArray ||
          "format-error, docId(s) should be an array";
      }
    }
    ...
    if (crudParams.token) {
      ...
      if (!testItem) {
        errors.token = mcMessages.isStringAlpha ||
          "format-error, token should be a string/alphanumeric";
      }
    }
    ...
    if (crudParams.userInfo) {
      ...
      if (!testItem) {
        errors.userInfo = mcMessages.isObject ||
          "format-error, userInfo should be an object";
      }
    }
...
export function validateLoadParams(crudParams: CrudParamsType) {
  ...
  try {
    if (crudParams.table) {
      ...
      if (!testItem) {
        errors.table = mcMessages.isStringAlpha ||
          "format-error, collection name should be a string/alphanumeric";
      }
    } else {
      errors.table = mcMessages.infoRequired ||
        "required-error, info is required";
    ...
    if (crudParams.actionParams) {
      ...
      if (!testItem) {
        errors.actionParams = mcMessages.isArray ||
          "format-error, actionParams should be an array";
      }
    } else {
      errors.actionParams = mcMessages.infoRequired ||
        "required-error; info is required";
    }
  } catch (e) {
