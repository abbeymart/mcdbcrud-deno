export const mcMessages = {
  ...
  confirmCashPayment:
    "Confirm cash-payment completed / received, to complete order - It cannot be undone",
  confirmInvoicePayment:
    "Confirm invoice-payment (pay-on-delivery, cheque, wire transfer), to complete order",
  confirmDelete:
    "Do you really want to permanently delete this record? It cannot be undone",
  ...
  validateInputs:
    "Required information must be provided in the required format",
  subItems: "Record contains sub-items and may not be removed",
  recordDeleted: "Record removed successfully",
  removeDenied:
    "You are not authorized / permitted to remove this record / item",
  ...
  descFormat:
    "Description contains unacceptable inputs... include permitted formats only",
  ...
  passwordMessage:
    "Password should include at least an upper-case and special character(@, #, $...)",
  passwordConfirm: "Password and confirm-Password must be the same",
  confirmPassRequired: "Confirmed password is required",
  stdCodeRequired:
    "Standard code name may contains letters, numbers, spaces and hyphens only",
  contentErrorMessage:
    "Content information should include valid title, category type and language",
  updateErrorMessage:
    "Unable to update record - try again or contact system administrator",
  insertErrorMessage:
    "Unable to create new record  - try again or contact system administrator",
  removeErrorMessage:
    "Unable to remove record  - try again or contact system administrator",
  searchErrorMessage:
    "Unable to retrieve record(s)  - try again or contact system administrator",
  paramErrorMessage:
    "Error validating the inputs - information required in the acceptable formats",
  updateNotAuthorized:
    "You are not authorized / permitted to update the record",
  noUpdate:
    "Update not completed - current record ID is unknown or not provided",
  ...
  getPostRequired:
    "GET or POST method is acceptable/required for this action/task",
  cancelTypeOrder: "Order - All Items",
  cancelTypeItem: "Item(s) - Part of Order",
  isStringAlpha:
    "Parameter should contains alphanumeric (a-z, A-Z, 0-9, -, _) only",
